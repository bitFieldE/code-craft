    ...
    class UsersController < ApplicationController
      ...
      def show
        ...
        render json: user.as_json(include: [{ posts: { include: [:tags], methods: :images_data } },
                                            ...
                                            { followings: { include: [:followings, :followers], methods: :image_url }},
                                            { followers: { include: [:followings, :followers], methods: :image_url} }, :tags], methods: %i[image_url tag_ranking])
      end
